...
public class ProductListPageTest extends BaseTest {
	...
	@Test(priority=3, description= "Adding Item to Cart",enabled = false)
	public void AddToCart_multiple_items_Validation_using_mousehover() throws Exception 
	{
	...
	String successmsg= plp.AddmultipleItem();
	System.out.println(successmsg);
	Assert.assertEquals(successmsg.contains(Constants.success_msge_multipleitems), true);
	...
	@Test(priority=4, description= "Adding Item to Cart")
...
@Test(priority=6, description= "Adding Recently viewed Item to cart in PLP")
...
@Test(priority=7, description= "Validating UOM in PLP")
